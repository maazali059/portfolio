...
function renderPhase2Nav(){
  document.getElementById('phase2Nav').innerHTML = PHASE2_TABS.map(t=>`
    ...
    + `<div class="wsTab" style="margin-left:auto;color:var(--text-faint)" data-action="gotoStep:decision">← Back to Phase 1</div>`;
...
/* ---------- nav actions ---------- */
function gotoStep(step){ STATE.step = step; window.scrollTo(0,0); render(); }
